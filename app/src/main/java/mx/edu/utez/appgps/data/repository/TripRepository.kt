package mx.edu.utez.appgps.data.repository

import android.content.Context
import mx.edu.utez.appgps.data.db.AppDatabase
import mx.edu.utez.appgps.data.db.LocationPoint
...
class TripRepository(context: Context) {
    ...
    suspend fun saveLocationPoint(point: LocationPoint) {  tripDao.insertLocationPoint(point)
    }
    suspend fun stopTripAndAddPhoto(tripId: Long, photoUri: String) {  val trip = tripDao.getTripById(tripId)
        trip?.let {
